...
public abstract class ClickGuard {
     ...
     */
    public static final long DEFAULT_WATCH_PERIOD_MILLIS = 100L;
    ...
    /**
     * Utility method. Let the provided {@linkplain View.OnClickListener OnClickListener}
     ...
     * @return A GuardedOnClickListener instance.
     */
    public static GuardedOnClickListener wrap(long watchPeriodMillis, View.OnClickListener onClickListener) {
     ...
     * @return A GuardedOnClickListener instance.
     */
    public static GuardedOnClickListener wrap(ClickGuard guard, View.OnClickListener onClickListener) {
    ...
    public static ClickGuard get(View view) {
        View.OnClickListener listener = retrieveOnClickListener(view);
    ...
    /**
     * Utility method. Retrieve {@linkplain View.OnClickListener OnClickListener} from
     * a View.
     *
     * @param view The View used to retrieve.
     * @return The retrieved {@linkplain View.OnClickListener OnClickListener}.
     */
    ...
    /**
     * Let the provided {@link View.OnClickListener} to be a {@link GuardedOnClickListener}
    ...
    public static abstract class GuardedOnClickListener implements View.OnClickListener {
        ...
        GuardedOnClickListener(View.OnClickListener onClickListener, ClickGuard guard) {
            mGuard = guard;
    ...
    static class InnerGuardedOnClickListener extends GuardedOnClickListener {
        InnerGuardedOnClickListener(View.OnClickListener onClickListener, ClickGuard guard) {
    ...
    static abstract class ListenerGetter {
        ...
        static View.OnClickListener get(View view) {
        ...
        abstract View.OnClickListener getOnClickListener(View view);
        ...
        private static class ListenerGetterBase extends ListenerGetter {
            ...
            public View.OnClickListener getOnClickListener(View view) {
                return (View.OnClickListener) getFieldValue(mOnClickListenerField, view);
            }
        }
        ...
        private static class ListenerGetterIcs extends ListenerGetter {
            ...
            public View.OnClickListener getOnClickListener(View view) {
                ...
                return listenerInfo != null ?
                        (View.OnClickListener) getFieldValue(mOnClickListenerField, listenerInfo) : null;
            }
        }
    }
}
